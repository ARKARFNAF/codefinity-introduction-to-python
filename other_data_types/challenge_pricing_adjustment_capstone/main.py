...
if egg_price > 5:
    ...
    grocery_inventory["Eggs"] = ("Dairy", egg_price -1 , grocery_inventory["Eggs"][2])
    print (grocery_inventory)
else:
    print("The price of Eggs is resonable.")
...
if milk_stock < 10:
    ...
    grocery_inventory["Milk"] = ("Dairy", grocery_inventory["Milk"][1], milk_stock + 20)
